...
public abstract class TrChatPlugin extends JavaPlugin {
    ...
    protected static TrChatPlugin plugin;
    ...
    protected static boolean forge = Loader.forName("net.minecraftforge.classloading.FMLForgePlugin", false, TrChatPlugin.class.getClassLoader()) != null;
    ...
    private static Class<?> getMainClass() {
        ...
        try {
            ZipFile zipFile = new ZipFile(toFile(TrChatPlugin.class.getProtectionDomain().getCodeSource().getLocation().openStream(), file));
    ...
    private static void init() {
        ...
        if (!libFile.exists()) {
            // 本地资源检测
            InputStream resourceAsStream = TrChatPlugin.class.getClassLoader().getResourceAsStream("TabooLib.jar");
    ...
    public static TrChatPlugin getPlugin() {
        return plugin;
    }
